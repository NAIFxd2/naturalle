...
import { Upload, FileSpreadsheet, CheckCircle, AlertTriangle, XCircle, Download, Loader, Trash2, Clock } from 'lucide-react';
        ...
        reader.onload = (evt) => {
            try {
                ...
                setPreview({
                    ...
                    uniqueFiscais: [...new Set(rows.map(r => r[headers.indexOf('FISCAIS')]).filter(Boolean))],
